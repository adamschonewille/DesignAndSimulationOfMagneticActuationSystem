...
actuator_vol = (1/1000^3) * (1.00*25.4)^3;  %[m^3]
...
m_actuator2 = actuator_mag * [1  0  0]'; %[Am^2]
% Position of magnets (centered)
p_wrist    = 1/1000 * [ 10  0  0]'; %[m] 
p_finger1  = 1/1000 * [ 22  1.5  0]'; %[m]
p_finger2  = 1/1000 * [ 22 -1.5  0]'; %[m]
p_actuator = 1/1000 * [-28  0  0]'; %[m]
p_actuator2 = 1/1000 * [72  0  0]'; %[m]
...
%% Second magnet
G_wrist = dipoleGradient((p_wrist-p_actuator2),m_actuator2);
G_finger1 = dipoleGradient((p_finger1-p_actuator2),m_actuator2);
G_finger2 = dipoleGradient((p_finger2-p_actuator2),m_actuator2);
% Utilize the rearranged force matrix
Force_wrist = Force_wrist + forceMatrix(m_wrist) * G_wrist;
Force_finger1 = Force_finger1 + forceMatrix(m_finger1) * G_finger1;
Force_finger2 = Force_finger2 + forceMatrix(m_finger2) * G_finger2;
% Calculate the magnetic field at the tool magnets that are generated by 
% the actuator magnet assuming it can be accurately represented by a 
% dipole field.
B_wrist = B_wrist + dipoleField((p_wrist-p_actuator2),m_actuator2);
B_finger1 = B_finger1 + dipoleField((p_finger1-p_actuator2),m_actuator2);
B_finger2 = B_finger2 + dipoleField((p_finger2-p_actuator2),m_actuator2);
% Use magnetic field and the skew symmetric matrix to calculate the torques
% that are applied to the tool magnets
Torque_wrist = skew(m_wrist) * B_wrist;
Torque_finger1 = skew(m_finger1) * B_finger1;
...
plot(p_actuator2(1),p_actuator2(2),'ko',"MarkerSize", markerSize,"LineWidth",lineWidth)
...
act2_x1 = p_actuator2(1)-s/2;
act2_x2 = p_actuator2(1)+s/2;
act2_y1 = p_actuator2(2)-s/2;
act2_y2 = p_actuator2(2)+s/2;
plot([act2_x1,act2_x2,act2_x2,act2_x1,act2_x1],[act2_y1,act2_y1,act2_y2,act2_y2,act2_y1],'k')
% Wrist magnet
